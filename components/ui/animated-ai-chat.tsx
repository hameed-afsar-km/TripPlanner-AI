...
export function AnimatedAIChat() {
    ...
    return (
        <div className="min-h-[calc(100vh-4rem)] flex flex-col w-full items-center justify-center bg-transparent text-white p-6 relative overflow-hidden">
                    ...
                    >
                        ...
                        <div className="p-4">
                            <Textarea
                                ...
                                placeholder="Plan a trip to Kyoto..."
